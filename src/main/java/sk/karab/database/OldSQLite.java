...
public class OldSQLite extends OldDatabase {
    String dbname;
    public OldSQLite(FPinata instance){
        super(instance);
        dbname = plugin.getConfig().getString("SQLite.Filename", "bob"); // Set the table name here e.g player_kills
    }
